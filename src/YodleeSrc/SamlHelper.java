...
public abstract class SamlHelper {
     ...
     */
    public static SamlHelper getSamlHelper(
        String keystoreFilename, String keystoreAlias, String keystorePassword) {
        ...
        try {
            ...
            samlHelper =
                (SamlHelper) samlHelperConstructor.newInstance(
                    new Object[] {
     ...
     */
    public abstract String generateResponseString(
     ...
     */
    public abstract String generateResponseString(
        String[] subjects, String issuer) throws Exception;
}
